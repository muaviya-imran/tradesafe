...
import PlayerCard from '@/components/dashboard2/player-card';
import FeaturedGame from '@/components/dashboard2/featured-game';
import StatsPanel from '@/components/dashboard2/stats-panel';
import MarketWatchlist from '@/components/dashboard2/market-watchlist';
